...
public class XMLparser {
	...
	public ArrayList<Tag> getTagListFromActricity(String filepath) throws Exception {
	...
	private StartEndTime getStartEnd(Element ar)
			throws IndexOutOfBoundsException {
		StartEndTime set = new StartEndTime();

		set.setAnfang(getTimeFromElement(getChildrenByName(ar, "Anfangszeit")
				.get(0)));
